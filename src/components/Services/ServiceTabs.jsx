...
function ServiceTabs() {
    ...
    return(
        <div>
            <div className="text-center mb-15 ml-20 mr-20 transform opacity-0 animate-slide-up" style={{ "--delay": "1" }}>
                <div className="text-[1.1rem] mb-5 flex justify-center font-lg"
                     style={{ '--text-color': 'var(--orange)' }}>
                    <button className="pl-8 pr-8 py-2 border-b-8 border-white hover:border-orange text-white hover:text-orange transition duration-500 ease-in-out"
                            style={{
                    ...
                    <button className="pl-8 pr-8 py-2 border-b-8 border-white hover:border-orange hover:border-orange text-white hover:text-orange transition duration-500 ease-in-out"
                            style={{
